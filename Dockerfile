...
RUN mkdir /usr/local/apache2/htdocs/publicfiles 
RUN mkdir /usr/local/apache2/htdocs/privatefiles
RUN mv archlinux* /usr/local/apache2/htdocs/publicfiles
RUN cp /usr/local/apache2/htdocs/publicfiles/* /usr/local/apache2/htdocs/privatefiles/
